...
<div>
	...
	<div class="text-right">
		<br/>
		<input type="submit" name="submit" value="Edit Blog" /> or <?php echo anchor(SITE_AREA .'/blog/blog', lang('blog_cancel')); ?>
	</div>
	<?php echo form_close(); ?>

	<div class="box delete rounded">
		<a class="button" id="delete-me" href="<?php echo site_url(SITE_AREA .'/blog/blog/delete/'. $id); ?>" onclick="return confirm('<?php echo lang('blog_delete_confirm'); ?>')"><?php echo lang('blog_delete_record'); ?></a>
