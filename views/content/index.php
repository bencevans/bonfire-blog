...
<div class="view split-view">
	...
	<div class="notification attention">
		<p><?php echo lang('blog_no_records'); ?> <?php echo anchor(SITE_AREA .'/content/blog/create', lang('blog_create_new'), array("class" => "ajaxify")) ?></p>
	</div>
	...
	<div id="content" class="view">
		<div class="scrollable" id="ajax-content">
			...
			<div class="box create rounded">
				<a class="button good ajaxify" href="<?php echo site_url(SITE_AREA .'/content/blog/create')?>"><?php echo lang('blog_create_new_button');?></a>
...
?>
				<td><?php echo anchor(SITE_AREA .'/content/blog/edit/'. $record['id'], lang('blog_edit'), 'class="ajaxify"'); ?></td>
			</tr>
<?php endforeach; ?>
		</tbody>
	</table>
