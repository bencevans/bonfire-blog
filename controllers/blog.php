...
class blog extends Front_Controller {
	...
	*/
	public function index() 
	{
		...
		Assets::add_js($this->load->view('blog/js', null, true), 'inline');
	...
	*/
	...
	{
		$this->auth->restrict('Blog.Blog.Create');
		...
		if ($this->input->post('submit'))
		{
			if ($insert_id = $this->save_blog())
			{
				...
				Template::redirect(SITE_AREA .'/blog/blog');
			}
			else 
			{
	...
	*/
	...
	{
		$this->auth->restrict('Blog.Blog.Edit');
	...
	*/
	...
	{	
		$this->auth->restrict('Blog.Blog.Delete');
